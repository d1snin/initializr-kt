...
internal object InitializrServiceImpl : InitializrService {
    ...
    override var defaultProjectConfiguration: AtomicReference<ProjectConfiguration?> = AtomicReference()
    ...
    override suspend fun newProject(configuration: ProjectConfiguration): ByteArray = withContext(Dispatchers.IO) {
        configuration.run {
